...
class Visualizer {
    constructor(node, container, visualSrc) {
        ...
        this.iframe.src = "/extensions/ComfyUI-Hunyuan3D-lite/html/" + visualSrc + ".html"
...
app.registerExtension({
    ...
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        registerVisualizer(nodeType, nodeData, "Hunyuan3DViewer", "threeVisualizer")
    },
})